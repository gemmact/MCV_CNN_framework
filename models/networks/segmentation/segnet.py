...
class SegNet(Net):
    #def __init__(self, cf, n_classes=21, in_channels=3, is_unpooling=True):
    def __init__(self, cf, num_classes=21, pretrained=False, net_name='segnet', is_unpooling=False):
